...
\otable switch, they are empty. When \otable is set, a \texttt{-I} flag
ensures that \menhirlib is visible to the \ocaml compiler.
...
\docswitch{\osuggestocamlfind} This switch is deprecated and may be removed in the future.
It always prints \texttt{false}.
